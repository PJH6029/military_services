...
$qry = sprintf("INSERT INTO `user_table` (`id`, `name`, `password`, `end_date`) VALUES ('%s', '%s', '%s', '%s');", $_POST["userId"], $_POST["userName"], hash("sha256", $_POST["userPw"]), $_POST["userEndDate"]);
