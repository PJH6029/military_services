...
class Card extends HTMLElement {
    ...
    async handleCardData(cardTable, cardId) {
    ...
    async getCard() {
        return CardHandler.getCard({id: this.cardId, table: this.cardTable});
    }
    ...
    attributeChangedCallback(attr, oldVal, newVal) {
        switch (attr) {
            case "card-info":
                ...
                this.cardId = parseInt(cardId);
                this.cardTable = cardTable;
                this.handleCardData(cardTable, cardId);
                break;
        }
    }
}

class MinimalCard extends Card {
    constructor() {
        super();
        this.shadowRoot.innerHTML = `
            <style>
                ...
                :host([pinned]) .head, :host([pinned]) .read-count {
                    display: none;
                }
